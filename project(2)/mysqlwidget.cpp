...
//    m_db.setHostName("localhost"); // 数据库服务器地址
//    m_db.setDatabaseName("localhost_3306"); // 数据库名
...
bool MySQLWidget::registerUser(QString&username,QString&password)
{
    ...
    if (!db.open()) {
       // QMessageBox::warning(m_parent,tr("提示"),tr("<span style='color: rgb(0, 0, 0); font-size: 24px;'>请先选中设备！</span>"),QMessageBox::Yes);
